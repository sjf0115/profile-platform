package com.data.connector.api.utils;

import com.data.connector.api.entity.QueryColumn;
import com.data.connector.api.entity.ResultList;
import com.data.connector.api.entity.ResultListWithColumns;
...
public class SqlUtils {
    ...
    public static List<String> extractTablesFromSelect(String sql) {
        ...
        try {
            ...
            throw new ProfileException("extract tables from select error", e);
        }
        return tables;
    }
}
