...
public class RuleExpressionTest {
    ...
    public static void main(String[] args) {
        ...
        RuleFilterGroup ruleFilterGroup11 = RuleFilterGroup.builder().filters(Collections.singletonList(ruleFilter11)).build();
        RuleFilterExpression ruleFilterExpression11 = RuleFilterExpression.builder().logic("AND").filterGroups(Arrays.asList(ruleFilterGroup11)).build();
        Rule rule11 = Rule.builder().type("1").filterExpression(ruleFilterExpression11).build();
        ...
        RuleFilterGroup ruleFilterGroup12 = RuleFilterGroup.builder().filters(Collections.singletonList(ruleFilter12)).build();
        RuleFilterExpression ruleFilterExpression12 = RuleFilterExpression.builder().logic("AND").filterGroups(Arrays.asList(ruleFilterGroup12)).build();
        Rule rule12 = Rule.builder().type("2").filterExpression(ruleFilterExpression12).build();
        ...
        RuleFilterGroup ruleFilterGroup13 = RuleFilterGroup.builder().filters(Collections.singletonList(ruleFilter13)).build();
        RuleFilterExpression ruleFilterExpression13 = RuleFilterExpression.builder().logic("AND").filterGroups(Arrays.asList(ruleFilterGroup13)).build();
        // 1.3.2 指标
        ...
        Rule rule13 = Rule.builder().type("3").filterExpression(ruleFilterExpression13).event(ruleEvent13).build();
        ...
        RuleFilterGroup ruleFilterGroup21 = RuleFilterGroup.builder().filters(Collections.singletonList(ruleFilter21)).build();
        RuleFilterExpression ruleFilterExpression21 = RuleFilterExpression.builder().logic("AND").filterGroups(Arrays.asList(ruleFilterGroup21)).build();
        Rule rule21 = Rule.builder().type("1").filterExpression(ruleFilterExpression21).build();
        ...
        RuleFilterGroup ruleFilterGroup22 = RuleFilterGroup.builder().filters(Collections.singletonList(ruleFilter22)).build();
        RuleFilterExpression ruleFilterExpression22 = RuleFilterExpression.builder().logic("AND").filterGroups(Arrays.asList(ruleFilterGroup22)).build();
        Rule rule22 = Rule.builder().type("2").filterExpression(ruleFilterExpression22).build();
        ...
        RuleFilterGroup ruleFilterGroup23 = RuleFilterGroup.builder().filters(Collections.singletonList(ruleFilter23)).build();
        RuleFilterExpression ruleFilterExpression23 = RuleFilterExpression.builder().logic("AND").filterGroups(Arrays.asList(ruleFilterGroup23)).build();
        // 2.3.2 指标
        ...
        Rule rule23 = Rule.builder().type("3").filterExpression(ruleFilterExpression23).event(ruleEvent23).build();
        ...
        RuleFilterGroup ruleFilterGroup31 = RuleFilterGroup.builder().filters(Collections.singletonList(ruleFilter31)).build();
        RuleFilterExpression ruleFilterExpression31 = RuleFilterExpression.builder().logic("AND").filterGroups(Arrays.asList(ruleFilterGroup31)).build();
        // 3.1.1.2 事件
        ...
        RuleFilterGroup ruleFilterGroup32 = RuleFilterGroup.builder().filters(Collections.singletonList(ruleFilter32)).build();
        RuleFilterExpression ruleFilterExpression32 = RuleFilterExpression.builder().logic("AND").filterGroups(Arrays.asList(ruleFilterGroup32)).build();
        // 3.1.2.2 事件
        ...
        Rule rule31 = Rule.builder().type("4").events(Arrays.asList(ruleSequence31, ruleSequence32)).build();
